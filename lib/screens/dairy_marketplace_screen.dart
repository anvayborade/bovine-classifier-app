...
class _DairyMarketplaceScreenState extends State<DairyMarketplaceScreen> {
  ...
  Future<void> _go() async {
    ...
    // 1) Nearby dairy buyers (plants/collection)
    try {
  ...
  Widget build(BuildContext c) => Scaffold(
    appBar: topLevelAppBar('Dairy marketplace'),
    ...
    body: Padding(
      ...
      child: Column(
        children: [
            ...
            child: _loadingPlaces
              ...
              children: [
                if (_places.isNotEmpty) ...[
                  const Text('Nearby dairy plants/collection:',
                ...
                if (_places.isEmpty && _placesErr == null)
                  const Padding(
                    ...
                    child: Text('No dairy buyers found yet.'),
                  ),
                ..._places.map((p) {
                  final title =
                  (p.name?.trim().isNotEmpty ?? false) ? p.name! : 'Unnamed facility';
                  return Column(
                    children: [
                      ListTile(
          ...
          // --- AI advice block below the list ---
